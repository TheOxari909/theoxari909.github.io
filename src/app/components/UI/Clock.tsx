...
const Clock = () => {
  ...
  return (
    <div className="relative z-30 mx-auto my-10 box-content flex h-48 w-48 items-center justify-center rounded-full border-4 border-black bg-slate-50">
      <div
        className="absolute left-2/4 top-4 z-30 mx-auto h-20 w-[3px] origin-bottom rounded-full bg-red-600"
        style={{ transform: `rotate(${secondDegrees}deg)` }}
      />
      <div
        className="absolute left-2/4 top-8 mx-auto h-16 w-[7px] origin-bottom bg-black"
        style={{ transform: `rotate(${hourDegrees}deg)` }}
      />
      <div
        className="absolute left-2/4 top-4 mx-auto h-20 w-[5px] origin-bottom bg-black"
